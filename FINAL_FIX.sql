-- FINAL COMPLETE FIX - RUN THIS FIRST
USE aptitude_quest;

-- Drop all tables and recreate properly
...
-- Insert admin with bcrypt password (admin123)
INSERT INTO admins (email, password) VALUES 
('admin@aptitudequest.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.');

-- Insert test students with bcrypt passwords (student123)
...
('logical', 'Which number comes next: 1, 4, 9, 16, ?', '20', '25', '30', '36', 'b'),
('verbal', 'What is the synonym of "abundant"?', 'Scarce', 'Plentiful', 'Rare', 'Limited', 'b');

SELECT 'ALL TABLES CREATED AND POPULATED - SYSTEM READY' as status;
